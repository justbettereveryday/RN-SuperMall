    ...
    renderNav(){
        return(
            <View style={styles.navOutViewStyle}>
                ...
                <Text style={{color:'white',fontSize:16,fontWeight:'bold',marginTop:10}}>商家</Text>
                <TouchableOpacity onPress={()=>{alert('点击了右键')}} style={styles.rightViewStyle}>
